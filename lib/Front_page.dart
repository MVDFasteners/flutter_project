...
class _CompanyHomePageState extends State<CompanyHomePage>
  ...
  final List<Map<String, dynamic>> buttonData = [
    {
      'label': 'Attendance',
      'imageAsset': 'assets/images/logo/check.png',
      'onTap': 'attendance',
    },
    {
      'label': 'Trip List',
      'imageAsset': 'assets/images/logo/location.png',
      'onTap': 'taskList',
    },
  ];
  ...
  void handleTaskList(BuildContext context) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Task List button pressed')),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: Stack(
          children: [
            Container(color: lighten(baseTeal, 0.99)), // lightest teal background
            ...
            child: Column(
              ...
              children: [
                Image.asset(
                  ...
                  const Icon(Icons.image_not_supported, size: 45, color: Color(0xff795900)),
                ),
